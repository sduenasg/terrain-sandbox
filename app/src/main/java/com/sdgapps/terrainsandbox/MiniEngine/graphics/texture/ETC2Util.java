    ...
    public static final class ETC2 {
        ...
        public static boolean isValid(ByteBuffer header) {
            ...
            if ((ETC2Magic[0] != header.get(0)) && (ETC2Magic[1] != header.get(1)) && (ETC2Magic[2] != header.get(2))
                ...
                Logger.err("ETC2 header failed magic sequence check.");
                ...
                if ((ETC1Magic[0] != header.get(0)) && (ETC1Magic[1] != header.get(1)) && (ETC1Magic[2] != header.get(2))
                    ...
                    Logger.err("ETC1 header failed magic sequence check.");
                    return false;
                }
            }
            ...
            switch (ETC2_FORMAT) {
                ...
                case SIGNED_RG11_EAC:
                    break;
                default:
                    Logger.err("ETC2 header failed format check.");
                    return false;
            }
            ...
            if (encodedWidth < width || (encodedWidth - width) > 4) {
                Logger.err("ETC2 header failed width check. Encoded: " + encodedWidth + " Actual: " + width);
                return false;
            }
            // Check the height
            if (encodedHeight < height || (encodedHeight - height) > 4) {
                Logger.err("ETC2 header failed height check. Encoded: " + encodedHeight + " Actual: " + height);
                return false;
            }
